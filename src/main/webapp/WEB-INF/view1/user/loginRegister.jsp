    ...
    <main class="cd-main-content">
        ...
        <div class="login-box" >
            <div class="box-con tran">
                <form class="login-con f-l" method="post"  action="${pageContext.request.contextPath}/login/websubmit" autocomplete="off">
                ...
                <div class="signup f-l">
                    <form class="signup-email" method="post" action="${pageContext.request.contextPath}/user/registerSubmit" autocomplete="off">
                        <div class="form-group">
