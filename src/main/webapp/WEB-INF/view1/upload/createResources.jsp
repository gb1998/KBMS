...
<div class="nav-index">
    <header class="cd-main-header animate-search">
        <div class="cd-logo"><a href="#"><img src="../img/logo1%20(3).png" alt="Logo" style="width: 124px; height: 23px"></a></div>
            ...
            <ul class="cd-main-nav">
                ...
                <li class="fix-menu-item-user">
                                        <span style="color: #fff;font-size: 15px;line-height: 1;cursor: pointer" onclick="showDropdownFix()">
                                           <img src="../img/boy.png" alt="waiting" class="img-rounded" style="width: 40px; height: 40px; margin-bottom: 5px">
                    ...
                    <div class="showPathList">
                        <ol>
                            <li class="itemElement">
                                <a href="../index.html">
                                    <span>首页</span>
                                    <img src="../img/zhixiang.png" alt="waiting">
                                </a>
                            </li>
                            <li class="itemElement">
                                <a href="#">
