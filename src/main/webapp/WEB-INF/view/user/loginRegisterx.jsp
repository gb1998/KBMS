...
<div class="nav-index">
    <header class="cd-main-header animate-search">
        <div class="cd-logo"><a href="index.html"><img src="img/logo1%20(3).png" alt="Logo" style="width: 124px; height: 23px"></a></div>
    ...
    <main class="cd-main-content">
        <div class="login-banner">
            <a href="#" class="admin-logo" >
                <img src="./img/boy.png" alt="waiting" data-toggle="tooltip"  data-placement="top" title="欢迎使用BigBang知识库" draggable="false">
            </a>
        </div>
        <div id="warndiv">
        ...
        <div class="login-box" >
            <div class="box-con tran">
                <form class="login-con f-l"  action="${pageContext.request.contextPath}/login/websubmit" method="post">
                ...
                <div class="signup f-l">
                    <form class="signup-email"  action="${pageContext.request.contextPath}/user/registerSubmit"  method="post">
                        <div class="form-group">
...
<script>
        ...
        $.ajax({
            ...
            'success' : function(data) {
                if(data.code==2)
                {
                    <!--去登陆页面,也就是刷新一下-->
                    alert(data.data)
                    window.location.href="${pageContext.request.contextPath}/user/registerPage"
                }
               else
                {
                    <!--不做跳转-->
    ...
    <!--登录的异步,登录成功，前往从那一个页面来，登录失败刷新本页也可以不刷新-->
    function loginSubmit() {
        var url="${pageContext.request.contextPath}/login/websubmit";
        var params={
