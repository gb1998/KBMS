           ...
           alert("你已经登录可以回复")
            ...
            function comment() {
                ...
                $.post(url, params, function(data) {
                    ...
                    var s='<div class="user-discuss-content">  <div class="media"> <a href="#" class="user-img"> <img src="/kbms/statics/img/default.png" alt="waiting"> <p class="user-name">黄翔</p> </a> <div class="media-body">\n' +
                        ...
                        '                                                                </div>\n' +
                        '                                                                <div>\n' +
                        '                                                                    <p class="media-body-info"></p><p> '+data.ct+'<br></p><p></p>\n' +
                        '                                                                </div>\n' +
                        '                                                                <div class="media-pop" style="width: 100%">\n' +
                        '                                                                    <img src="/kbms/statics/img/dianzan.png" alt="" onclick="clickBlueZan(this)" style="cursor: pointer">\n' +
                        '                                                                    0\n' +
                        '                                                                    <img src="/kbms/statics/img/liuyan.png" alt="" style="cursor:pointer" onclick="clickShowBigReply(this)">\n' +
                        '                                                                    0\n' +
                        '                                                                    <span style="float: right">评论于 2019-04-23 22:31</span>\n' +
                        '                                                                </div>\n' +
                        '                                                              \n' +
                        '                                                            </div>\n' +
                        '\n' +
                    ...
                    $(".user-discuss-list").eq(0).prepend(s);
                                                        ...
                                                        <div class="media-body">
                                                            <div class="pull-left" style="margin-left: 4px">
                                                                ...
                                                                <div class="second-comment"  style="display: none">
                                                                    ...
                                                                    <!--回复列表，对空的也要进行判断和处理，不论列表框是否为空，都应该把单一的评论回复框加上，针对每一条评论-->
                ...
                <div class="modal-body payment-way">
                    ...
                    <div class="my-payment-img payment-one" style="display: block">
                        <div class="qrcode-border box-size" style="border: 9.02px solid rgb(60 , 175 , 54)">
                            <img src="${pageContext.request.contextPath}/statics/img/c14a56ae7f7d0b3313288516b19ad74c.jpg" alt="waiting" style="display: inline-block">
                        </div>
                    ...
                    <div class="my-payment-img payment-two" style="display: none">
                        <div class="qrcode-border box-size" style="border: 9.02px solid rgb(102 , 153 , 204)">
                            <img src="${pageContext.request.contextPath}/statics/img/fd5dc70f7bf53954e1a97d8160878266.jpg" alt="waiting" style="display: inline-block">
                        </div>
                    ...
                    <div class="my-payment-img payment-three" style="display: none">
                        <div class="qrcode-border box-size" style="border: 9.02px solid rgb(235 , 95 , 1)">
                            <img src="${pageContext.request.contextPath}/statics/img/65acb3aa46193bc0a19acf4a0bed12f0.jpg" alt="waiting" style="display: inline-block">
                        </div>
